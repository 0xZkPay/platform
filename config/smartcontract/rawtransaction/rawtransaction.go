...
import (
	...
	"github.com/0xZkPay/platform/config/smartcontract"
	"github.com/0xZkPay/platform/util/pkg/ethwallet"
...
func SendRawTransaction(abiS string, method string, args ...interface{}) (*types.Transaction, error) {
	...
	envContractAddress := envconfig.EnvVars.ZKPAY_CONTRACT_ADDRESS
